...
## 成功事例（このレベルの新しさが必要）
- タピオカミルクティー（台湾→日本、上陸前は日本で無名だった）
- マリトッツォ（イタリア→日本、上陸前は日本人の99%が知らなかった）
- ドバイチョコ（UAE→日本、SNSで突然バズった新商品）
- 台湾カステラ（台湾→日本、日本にない新食感だった）

## 絶対に除外すべきもの（日本で既に知られている）
抹茶、ほうじ茶、コチュジャン、キムチ、寿司、ラーメン、餃子、
タピオカ、チーズタッカルビ、ビビンバ、フォー、バインミー、
カヌレ、マリトッツォ、台湾カステラ、ドバイチョコ、生タピオカ、
チュロス、クロッフル、マカロン、ティラミス、パンナコッタ、
その他日本のコンビニやスーパーで買えるもの全般
...
3. **日本でまだ無名なもの**（日本のコンビニ・スーパー・飲食チェーンで見かけないもの）
4. 日本の飲食店で再現可能なもの
5. 日本で既に定着している食品（抹茶、ほうじ茶、コチュジャン、キムチ等）は絶対に除外
6. 具体的な商品名や料理名であること（「food trend」のような一般ワードは不可）
