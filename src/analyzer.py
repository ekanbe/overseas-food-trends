...
「まだ日本に上陸していない、次にバズりそうなもの」を厳選して報告してください。

## あなたの役割
日本人の99%が名前すら聞いたことがない「海外の新しい食べ物」を見つけること。
日本語でGoogle検索して情報がほとんど出てこないレベルの新しさが必要。

## 除外ルール（これが最重要）
以下に該当するものは絶対に選ばないこと:
- 日本のコンビニ、スーパー、飲食チェーンで見たことがあるもの
- 日本のSNSやテレビで既に話題になったもの
- 日本語のWikipedia記事が存在するもの
- 日本の食品メーカーが既に商品化しているもの
- 伝統的な各国料理（キムチ、フォー、トムヤムクン等）

具体的な除外例（これらは絶対に選ぶな）:
ドバイチョコ、マリトッツォ、台湾カステラ、タピオカ、チーズタッカルビ、
クロッフル、カヌレ、抹茶、ほうじ茶、コチュジャン、キムチ、
スパム、スパム丼、おにぎらず、ビビンバ、フォー、バインミー、
チュロス、マカロン、ティラミス、パンナコッタ、アサイーボウル、
グラノーラ、スムージーボウル、エッグベネディクト、パンケーキ
...
2. 直近1週間で海外SNSで急激にバズっているもの
3. **日本人の99%が知らないもの限定**（迷ったら除外すること）
4. 日本の飲食店で再現可能なもの
5. 日本語でGoogle検索してほぼ情報が出ないレベルの新しさが必要
6. 具体的な新商品・新料理名であること（既存料理や一般ワードは不可）
